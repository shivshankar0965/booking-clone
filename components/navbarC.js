...
${dp()}
    ...
    <div id=""tabs>
 <a href="" id="tab1" onclick="tab1func()"><i class="ri-hotel-bed-line"></i>Stays</a>
 <a href="../carrental.html" id="tab2" onclick="tab2func()"><i class="ri-flight-takeoff-line"></i>Flights</a>
 <a href="" id="tab3" onclick="tab3func()"><i class="ri-global-line" ></i>Flight + Hotel</a>
 <a href="" id="tab4" onclick="tab4func()"><i class="ri-car-line"></i>Car rentals</a>
 <a href="" id="tab5" onclick="tab5func()"><i class="ri-baidu-line"></i>Attractions</a>
 <a href="" id="tab6" onclick="tab6func()"><i class="ri-taxi-line"></i>Airport taxis</a>
    </div>
</div>`
}
...
<img style="width:30px ;border:2px solid rgb(254,187,2)" src="https://cf.bstatic.com/static/img/identity/profile/b47cd0e05ec8b7831167f4f7593ead56402a6bb4.svg" alt="" />
        ...
        <p  style="line-height:5px;text-align:center;color:rgb(254,187,2);cursor: pointer;">Sign out</p>
        </div>
